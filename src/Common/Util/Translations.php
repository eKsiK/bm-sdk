...
class Translations
{
    ...
    private $translations = [
        'pl' => [
            ...
            self::JAVASCRIPT_REQUIRED => 'Aby przejść do Bramki Płatniczej Blue Media, musisz włączyć obsługę JavaScript w przeglądarce.',
        ],
        'en' => [
            ...
            self::JAVASCRIPT_REQUIRED => 'To access the Blue Media Payment Gateway, you need to enable JavaScript in your browser.',
        ],
        'de' => [
            ...
            self::JAVASCRIPT_REQUIRED => 'Damit du auf die zahlungspflichtige Seite Blue Media zugreifen kannst, aktiviere das JavaScript.',
        ],
    ];

    public function getTranslation(string $language, array $required_translations = self::REQUIRED_TRANSLATIONS): array
    {
        if (false === array_key_exists($language, $this->translations)) {
            $language = 'en';
        }
